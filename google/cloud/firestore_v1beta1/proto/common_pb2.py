...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    serialized_options=_b(
        "\n\034com.google.cloud.firestore.v1beta1B\013CommonProtoP\001ZAgoogle.golang.org/genproto/googleapis/firestore/v1beta1;firestore\242\002\004GCFS\252\002\036Google.Cloud.Firestore.V1Beta1\312\002\036Google\\Cloud\\Firestore\\V1beta1"
    ),
    serialized_pb=_b(
        '\n1google/cloud/firestore_v1beta1/proto/common.proto\x12\x18google.cloud.firestore.v1beta1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/api/annotations.proto"#\n\x0c\x44ocumentMask\x12\x13\n\x0b\x66ield_paths\x18\x01 \x03(\t"e\n\x0cPrecondition\x12\x10\n\x06\x65xists\x18\x01 \x01(\x08H\x00\x12\x31\n\x0bupdate_time\x18\x02 \x01(\x0b\x32\x1a.google.protobuf.TimestampH\x00\x42\x10\n\x0e\x63ondition_type"\xb3\x02\n\x12TransactionOptions\x12J\n\tread_only\x18\x02 \x01(\x0b\x32\x35.google.cloud.firestore.v1beta1.TransactionOptions.ReadOnlyH\x00\x12L\n\nread_write\x18\x03 \x01(\x0b\x32\x36.google.cloud.firestore.v1beta1.TransactionOptions.ReadWriteH\x00\x1a&\n\tReadWrite\x12\x19\n\x11retry_transaction\x18\x01 \x01(\x0c\x1aS\n\x08ReadOnly\x12/\n\tread_time\x18\x02 \x01(\x0b\x32\x1a.google.protobuf.TimestampH\x00\x42\x16\n\x14\x63onsistency_selectorB\x06\n\x04modeB\xb9\x01\n\x1c\x63om.google.cloud.firestore.v1beta1B\x0b\x43ommonProtoP\x01ZAgoogle.golang.org/genproto/googleapis/firestore/v1beta1;firestore\xa2\x02\x04GCFS\xaa\x02\x1eGoogle.Cloud.Firestore.V1Beta1\xca\x02\x1eGoogle\\Cloud\\Firestore\\V1beta1b\x06proto3'
    ),
    dependencies=[
...
_DOCUMENTMASK = _descriptor.Descriptor(
    name="DocumentMask",
    full_name="google.cloud.firestore.v1beta1.DocumentMask",
    filename=None,
    file=DESCRIPTOR,
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="field_paths",
            full_name="google.cloud.firestore.v1beta1.DocumentMask.field_paths",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_PRECONDITION = _descriptor.Descriptor(
    name="Precondition",
    full_name="google.cloud.firestore.v1beta1.Precondition",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="exists",
            full_name="google.cloud.firestore.v1beta1.Precondition.exists",
            index=0,
            number=1,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="update_time",
            full_name="google.cloud.firestore.v1beta1.Precondition.update_time",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="condition_type",
            full_name="google.cloud.firestore.v1beta1.Precondition.condition_type",
            index=0,
            containing_type=None,
            fields=[],
        )
...
_TRANSACTIONOPTIONS_READWRITE = _descriptor.Descriptor(
    name="ReadWrite",
    full_name="google.cloud.firestore.v1beta1.TransactionOptions.ReadWrite",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.firestore.v1beta1.TransactionOptions.ReadWrite.retry_transaction",
            index=0,
            number=1,
            type=12,
            cpp_type=9,
...
_TRANSACTIONOPTIONS_READONLY = _descriptor.Descriptor(
    name="ReadOnly",
    full_name="google.cloud.firestore.v1beta1.TransactionOptions.ReadOnly",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="read_time",
            full_name="google.cloud.firestore.v1beta1.TransactionOptions.ReadOnly.read_time",
            index=0,
            number=2,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            ...
            full_name="google.cloud.firestore.v1beta1.TransactionOptions.ReadOnly.consistency_selector",
            index=0,
            containing_type=None,
            fields=[],
        )
...
_TRANSACTIONOPTIONS = _descriptor.Descriptor(
    ...
    full_name="google.cloud.firestore.v1beta1.TransactionOptions",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="read_only",
            full_name="google.cloud.firestore.v1beta1.TransactionOptions.read_only",
            index=0,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="read_write",
            full_name="google.cloud.firestore.v1beta1.TransactionOptions.read_write",
            index=1,
            number=3,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="mode",
            full_name="google.cloud.firestore.v1beta1.TransactionOptions.mode",
            index=0,
            containing_type=None,
            fields=[],
        )
...
DocumentMask = _reflection.GeneratedProtocolMessageType(
  ...
  [Document][google.cloud.firestore.v1beta1.Document], and takes in account the
  dynamic nature of [Value][google.cloud.firestore.v1beta1.Value].
  ...
  """,
        # @@protoc_insertion_point(class_scope:google.cloud.firestore.v1beta1.DocumentMask)
    ),
)
...
Precondition = _reflection.GeneratedProtocolMessageType(
  ...
  """,
        # @@protoc_insertion_point(class_scope:google.cloud.firestore.v1beta1.Precondition)
    ),
)
...
TransactionOptions = _reflection.GeneratedProtocolMessageType(
    ...
    """,
                # @@protoc_insertion_point(class_scope:google.cloud.firestore.v1beta1.TransactionOptions.ReadWrite)
            ),
        ),
    ...
    Attributes:
        ...
        read_time:
            ...
            60 seconds.
    """,
                # @@protoc_insertion_point(class_scope:google.cloud.firestore.v1beta1.TransactionOptions.ReadOnly)
            ),
        ),
  ...
  Attributes:
      ...
      read_write:
          ...
          operations.
  """,
        # @@protoc_insertion_point(class_scope:google.cloud.firestore.v1beta1.TransactionOptions)
    ),
)
