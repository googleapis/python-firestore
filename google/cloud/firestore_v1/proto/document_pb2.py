...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    serialized_options=_b(
        "\n\027com.google.cloud.firestore.v1B\rDocumentProtoP\001Z<google.golang.org/genproto/googleapis/firestore/v1;firestore\242\002\004GCFS\252\002\031Google.Cloud.Firestore.V1\312\002\031Google\\Cloud\\Firestore\\V1"
    ),
    serialized_pb=_b(
        '\n.google/cloud/firestore_v1/proto/document.proto\x12\x13google.cloud.firestore.v1\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x18google/type/latlng.proto\x1a\x1cgoogle/api/annotations.proto"\x80\x02\n\x08\x44ocument\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x39\n\x06\x66ields\x18\x02 \x03(\x0b\x32).google.cloud.firestore.v1.Document.FieldsEntry\x12/\n\x0b\x63reate_time\x18\x03 \x01(\x0b\x32\x1a.google.protobuf.Timestamp\x12/\n\x0bupdate_time\x18\x04 \x01(\x0b\x32\x1a.google.protobuf.Timestamp\x1aI\n\x0b\x46ieldsEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12)\n\x05value\x18\x02 \x01(\x0b\x32\x1a.google.cloud.firestore.v1.Value:\x02\x38\x01"\xae\x03\n\x05Value\x12\x30\n\nnull_value\x18\x0b \x01(\x0e\x32\x1a.google.protobuf.NullValueH\x00\x12\x17\n\rboolean_value\x18\x01 \x01(\x08H\x00\x12\x17\n\rinteger_value\x18\x02 \x01(\x03H\x00\x12\x16\n\x0c\x64ouble_value\x18\x03 \x01(\x01H\x00\x12\x35\n\x0ftimestamp_value\x18\n \x01(\x0b\x32\x1a.google.protobuf.TimestampH\x00\x12\x16\n\x0cstring_value\x18\x11 \x01(\tH\x00\x12\x15\n\x0b\x62ytes_value\x18\x12 \x01(\x0cH\x00\x12\x19\n\x0freference_value\x18\x05 \x01(\tH\x00\x12.\n\x0fgeo_point_value\x18\x08 \x01(\x0b\x32\x13.google.type.LatLngH\x00\x12\x36\n\x0b\x61rray_value\x18\t \x01(\x0b\x32\x1f.google.cloud.firestore.v1.ArrayValueH\x00\x12\x32\n\tmap_value\x18\x06 \x01(\x0b\x32\x1d.google.cloud.firestore.v1.MapValueH\x00\x42\x0c\n\nvalue_type"8\n\nArrayValue\x12*\n\x06values\x18\x01 \x03(\x0b\x32\x1a.google.cloud.firestore.v1.Value"\x90\x01\n\x08MapValue\x12\x39\n\x06\x66ields\x18\x01 \x03(\x0b\x32).google.cloud.firestore.v1.MapValue.FieldsEntry\x1aI\n\x0b\x46ieldsEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12)\n\x05value\x18\x02 \x01(\x0b\x32\x1a.google.cloud.firestore.v1.Value:\x02\x38\x01\x42\xa7\x01\n\x17\x63om.google.cloud.firestore.v1B\rDocumentProtoP\x01Z<google.golang.org/genproto/googleapis/firestore/v1;firestore\xa2\x02\x04GCFS\xaa\x02\x19Google.Cloud.Firestore.V1\xca\x02\x19Google\\Cloud\\Firestore\\V1b\x06proto3'
    ),
    dependencies=[
...
_DOCUMENT_FIELDSENTRY = _descriptor.Descriptor(
    name="FieldsEntry",
    full_name="google.cloud.firestore.v1.Document.FieldsEntry",
    filename=None,
    file=DESCRIPTOR,
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="google.cloud.firestore.v1.Document.FieldsEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="google.cloud.firestore.v1.Document.FieldsEntry.value",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_DOCUMENT = _descriptor.Descriptor(
    name="Document",
    full_name="google.cloud.firestore.v1.Document",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="google.cloud.firestore.v1.Document.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="fields",
            full_name="google.cloud.firestore.v1.Document.fields",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="create_time",
            full_name="google.cloud.firestore.v1.Document.create_time",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="update_time",
            full_name="google.cloud.firestore.v1.Document.update_time",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
...
_VALUE = _descriptor.Descriptor(
    name="Value",
    full_name="google.cloud.firestore.v1.Value",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="null_value",
            full_name="google.cloud.firestore.v1.Value.null_value",
            index=0,
            number=11,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="boolean_value",
            full_name="google.cloud.firestore.v1.Value.boolean_value",
            index=1,
            number=1,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="integer_value",
            full_name="google.cloud.firestore.v1.Value.integer_value",
            index=2,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="double_value",
            full_name="google.cloud.firestore.v1.Value.double_value",
            index=3,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.firestore.v1.Value.timestamp_value",
            index=4,
            number=10,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="string_value",
            full_name="google.cloud.firestore.v1.Value.string_value",
            index=5,
            number=17,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="bytes_value",
            full_name="google.cloud.firestore.v1.Value.bytes_value",
            index=6,
            number=18,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.firestore.v1.Value.reference_value",
            index=7,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.cloud.firestore.v1.Value.geo_point_value",
            index=8,
            number=8,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="array_value",
            full_name="google.cloud.firestore.v1.Value.array_value",
            index=9,
            number=9,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="map_value",
            full_name="google.cloud.firestore.v1.Value.map_value",
            index=10,
            number=6,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="value_type",
            full_name="google.cloud.firestore.v1.Value.value_type",
            index=0,
            containing_type=None,
            fields=[],
        )
...
_ARRAYVALUE = _descriptor.Descriptor(
    name="ArrayValue",
    full_name="google.cloud.firestore.v1.ArrayValue",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="values",
            full_name="google.cloud.firestore.v1.ArrayValue.values",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_MAPVALUE_FIELDSENTRY = _descriptor.Descriptor(
    name="FieldsEntry",
    full_name="google.cloud.firestore.v1.MapValue.FieldsEntry",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="google.cloud.firestore.v1.MapValue.FieldsEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="google.cloud.firestore.v1.MapValue.FieldsEntry.value",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_MAPVALUE = _descriptor.Descriptor(
    name="MapValue",
    full_name="google.cloud.firestore.v1.MapValue",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="fields",
            full_name="google.cloud.firestore.v1.MapValue.fields",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
Document = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        FieldsEntry=_reflection.GeneratedProtocolMessageType(
            ...
            dict(
                ...
                # @@protoc_insertion_point(class_scope:google.cloud.firestore.v1.Document.FieldsEntry)
            ),
        ),
  ...
  """,
        # @@protoc_insertion_point(class_scope:google.cloud.firestore.v1.Document)
    ),
)
...
Value = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      map_value:
          A map value.
  """,
        # @@protoc_insertion_point(class_scope:google.cloud.firestore.v1.Value)
    ),
)
...
ArrayValue = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      values:
          Values in the array.
  """,
        # @@protoc_insertion_point(class_scope:google.cloud.firestore.v1.ArrayValue)
    ),
)
...
MapValue = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        FieldsEntry=_reflection.GeneratedProtocolMessageType(
            ...
            dict(
                ...
                __module__="google.cloud.firestore_v1.proto.document_pb2"
                # @@protoc_insertion_point(class_scope:google.cloud.firestore.v1.MapValue.FieldsEntry)
            ),
        ),
  ...
  """,
        # @@protoc_insertion_point(class_scope:google.cloud.firestore.v1.MapValue)
    ),
)
