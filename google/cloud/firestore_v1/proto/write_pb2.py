...
_WRITE.fields_by_name['update'].message_type = google_dot_cloud_dot_firestore__v1_dot_proto_dot_document__pb2._DOCUMENT
_WRITE.fields_by_name['transform'].message_type = _DOCUMENTTRANSFORM
_WRITE.fields_by_name['update_mask'].message_type = google_dot_cloud_dot_firestore__v1_dot_proto_dot_common__pb2._DOCUMENTMASK
_WRITE.fields_by_name['update_transforms'].message_type = _DOCUMENTTRANSFORM_FIELDTRANSFORM
_WRITE.fields_by_name['current_document'].message_type = google_dot_cloud_dot_firestore__v1_dot_proto_dot_common__pb2._PRECONDITION
...
_DOCUMENTTRANSFORM_FIELDTRANSFORM.fields_by_name['increment'].message_type = google_dot_cloud_dot_firestore__v1_dot_proto_dot_document__pb2._VALUE
_DOCUMENTTRANSFORM_FIELDTRANSFORM.fields_by_name['maximum'].message_type = google_dot_cloud_dot_firestore__v1_dot_proto_dot_document__pb2._VALUE
_DOCUMENTTRANSFORM_FIELDTRANSFORM.fields_by_name['minimum'].message_type = google_dot_cloud_dot_firestore__v1_dot_proto_dot_document__pb2._VALUE
_DOCUMENTTRANSFORM_FIELDTRANSFORM.fields_by_name['append_missing_elements'].message_type = google_dot_cloud_dot_firestore__v1_dot_proto_dot_document__pb2._ARRAYVALUE
_DOCUMENTTRANSFORM_FIELDTRANSFORM.fields_by_name['remove_all_from_array'].message_type = google_dot_cloud_dot_firestore__v1_dot_proto_dot_document__pb2._ARRAYVALUE
...
_WRITERESULT.fields_by_name['transform_results'].message_type = google_dot_cloud_dot_firestore__v1_dot_proto_dot_document__pb2._VALUE
_DOCUMENTCHANGE.fields_by_name['document'].message_type = google_dot_cloud_dot_firestore__v1_dot_proto_dot_document__pb2._DOCUMENT
...
Write = _reflection.GeneratedProtocolMessageType('Write', (_message.Message,), {
  ...
  Attributes:
      ...
      update_mask:
          ...
          reserved field name.
      update_transforms:
          The transforms to perform after update.  This field can be set
          only when the operation is ``update``. If present, this write
          is equivalent to performing ``update`` and ``transform`` to
...
DocumentChange = _reflection.GeneratedProtocolMessageType('DocumentChange', (_message.Message,), {
  ...
  '__module__' : 'google.cloud.firestore_v1.proto.write_pb2'
  ,
  '__doc__': """A [Document][google.firestore.v1.Document] has changed.  May be the
  result of multiple [writes][google.firestore.v1.Write], including
...
DocumentDelete = _reflection.GeneratedProtocolMessageType('DocumentDelete', (_message.Message,), {
  ...
  '__module__' : 'google.cloud.firestore_v1.proto.write_pb2'
  ,
  '__doc__': """A [Document][google.firestore.v1.Document] has been deleted.  May be
  the result of multiple [writes][google.firestore.v1.Write], including
...
DocumentRemove = _reflection.GeneratedProtocolMessageType('DocumentRemove', (_message.Message,), {
  ...
  view of the targets.  Sent if the document is no longer relevant to a
  target and is out of view. Can be sent instead of a DocumentDelete or
  a DocumentChange if the server can not send the new value of the
  document.  Multiple
