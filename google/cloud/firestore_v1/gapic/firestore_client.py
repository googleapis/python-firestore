...
class FirestoreClient(object):
    ...
    def batch_write(
        ...
        if 'batch_write' not in self._inner_api_calls:
            self._inner_api_calls['batch_write'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        return self._inner_api_calls['batch_write'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def partition_query(
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['partition_query'], retry=retry, timeout=timeout, metadata=metadata),
            request=request,
