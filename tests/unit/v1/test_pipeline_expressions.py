...
class TestConstant:
    @pytest.mark.parametrize("input_val, to_pb_val",[
        ...
        (
            [0.0, 1.0, 2.0],
            Value(array_value={"values": [Value(double_value=i) for i in range(3)]}),
        ),
    ...
    @pytest.mark.parametrize("input_val,expected", [
        ...
        (datetime.datetime(2025, 5, 12), "Constant.of(datetime.datetime(2025, 5, 12, 0, 0))"),
