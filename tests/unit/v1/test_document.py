...
class TestDocumentReference(unittest.TestCase):
    ...
    def _collections_helper(self, page_size=None, page_token=None):
        ...
        if page_token:
            ...
            api_client.list_collection_ids.side_effect = [iterator1, iterator]
        ...
        if page_token:
            ...
            api_client.list_collection_ids.call_count = 2
        else:
            # Verify the response and the mocks.
    ...
    def test_collections_w_next_page(self):
        self._collections_helper(page_token="next_page_token")
