...
from google.cloud.firestore.firestore_admin_v1.services.firestore_admin import (
    FirestoreAdminAsyncClient,
)
from google.cloud.firestore.firestore_admin_v1.services.firestore_admin import (
    FirestoreAdminClient,
)
from google.cloud.firestore.firestore_admin_v1.services.firestore_admin import pagers
from google.cloud.firestore.firestore_admin_v1.services.firestore_admin import (
    transports,
)
from google.cloud.firestore.firestore_admin_v1.types import field
from google.cloud.firestore.firestore_admin_v1.types import field as gfa_field
from google.cloud.firestore.firestore_admin_v1.types import firestore_admin
from google.cloud.firestore.firestore_admin_v1.types import index
from google.cloud.firestore.firestore_admin_v1.types import index as gfa_index
from google.cloud.firestore.firestore_admin_v1.types import operation as gfa_operation
...
def test_firestore_admin_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.firestore.firestore_admin_v1.services.firestore_admin.transports.FirestoreAdminGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_firestore_admin_base_transport():
    ...
    with mock.patch(
        "google.cloud.firestore.firestore_admin_v1.services.firestore_admin.transports.FirestoreAdminTransport.__init__"
    ) as Transport:
...
def test_firestore_admin_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.firestore.firestore_admin_v1.services.firestore_admin.transports.FirestoreAdminTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
