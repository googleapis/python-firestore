...
from google.cloud.admin_v1.services.firestore_admin import FirestoreAdminAsyncClient
from google.cloud.admin_v1.services.firestore_admin import FirestoreAdminClient
from google.cloud.admin_v1.services.firestore_admin import pagers
from google.cloud.admin_v1.services.firestore_admin import transports
...
from google.cloud.admin_v1.types import operation as gfa_operation
...
def test_firestore_admin_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.admin_v1.services.firestore_admin.transports.FirestoreAdminGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_firestore_admin_base_transport():
    ...
    with mock.patch(
        "google.cloud.admin_v1.services.firestore_admin.transports.FirestoreAdminTransport.__init__"
    ) as Transport:
...
def test_firestore_admin_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.admin_v1.services.firestore_admin.transports.FirestoreAdminTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
