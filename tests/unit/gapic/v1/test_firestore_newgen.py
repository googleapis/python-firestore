...
from google.firestore_v1.services.firestore import FirestoreClient
from google.firestore_v1.services.firestore import pagers
from google.firestore_v1.services.firestore import transports
...
def test_firestore_client_from_service_account_file():
    creds = credentials.AnonymousCredentials()
    with mock.patch.object(service_account.Credentials, 'from_service_account_file') as factory:
        factory.return_value = creds
        client = FirestoreClient.from_service_account_file("dummy/file/path.json")
        assert client._transport._credentials == creds

        client = FirestoreClient.from_service_account_json("dummy/file/path.json")
        assert client._transport._credentials == creds
...
def test_firestore_client_client_options():
    # Check that if channel is provided we won't create a new one.
    with mock.patch('google.firestore_v1.services.firestore.FirestoreClient.get_transport_class') as gtc:
    ...
    with mock.patch('google.firestore_v1.services.firestore.FirestoreClient.get_transport_class') as gtc:
        client = FirestoreClient(transport="grpc")
        gtc.assert_called()

    # Check the case api_endpoint is provided.
    options = client_options.ClientOptions(api_endpoint="squid.clam.whelk")
    with mock.patch('google.firestore_v1.services.firestore.transports.FirestoreGrpcTransport.__init__') as grpc_transport:
        grpc_transport.return_value = None
        client = FirestoreClient(client_options=options)
...
def test_get_document(transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client._transport.get_document),
            '__call__') as call:
...
def test_list_documents(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.list_documents),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_documents_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in client.list_documents(
            request={},
        )]
...
def test_update_document(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.update_document),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_document(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.delete_document),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_batch_get_documents(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.batch_get_documents),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_begin_transaction(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.begin_transaction),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_commit_flattened():
    ...
    with mock.patch.object(
        ...
        _, args, _ = call.mock_calls[0]
        assert args[0].database == 'database_value'
        assert args[0].writes == [gf_write.Write(update=gf_document.Document(name='name_value'))]
...
def test_rollback(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.rollback),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_run_query(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.run_query),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_partition_query(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.partition_query),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_partition_query_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in client.partition_query(
            request={},
        )]
        assert len(results) == 6
...
def test_list_collection_ids(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.list_collection_ids),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_batch_write(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.batch_write),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_document(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.create_document),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = document.Document(
            name='name_value',
