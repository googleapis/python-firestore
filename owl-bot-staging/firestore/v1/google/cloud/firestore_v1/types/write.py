...
class Write(proto.Message):
    ...
    update_transforms: MutableSequence['DocumentTransform.FieldTransform'] = proto.RepeatedField(
        proto.MESSAGE,
        number=7,
...
class DocumentTransform(proto.Message):
    ...
    class FieldTransform(proto.Message):
        ...
        set_to_server_value: 'DocumentTransform.FieldTransform.ServerValue' = proto.Field(
            proto.ENUM,
            number=2,
