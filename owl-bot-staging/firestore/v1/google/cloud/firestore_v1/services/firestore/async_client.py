...
class FirestoreAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, FirestoreTransport, Callable[..., FirestoreTransport]]] = "grpc_asyncio",
    ...
    def batch_get_documents(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.batch_get_documents]
    ...
    async def list_collection_ids(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_collection_ids]
