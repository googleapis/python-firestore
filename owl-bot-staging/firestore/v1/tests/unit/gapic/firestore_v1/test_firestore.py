    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.batch_get_documents] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.write] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.listen] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.list_collection_ids] = mock_object
...
def test_get_document_rest_bad_request(transport: str = 'rest', request_type=firestore.GetDocumentRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_documents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = firestore.ListDocumentsResponse.to_json(firestore.ListDocumentsResponse())
...
def test_list_documents_rest_bad_request(transport: str = 'rest', request_type=firestore.ListDocumentsRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_document_rest_bad_request(transport: str = 'rest', request_type=firestore.UpdateDocumentRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_document_rest_bad_request(transport: str = 'rest', request_type=firestore.DeleteDocumentRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_get_documents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = firestore.BatchGetDocumentsResponse.to_json(firestore.BatchGetDocumentsResponse())
...
def test_batch_get_documents_rest_bad_request(transport: str = 'rest', request_type=firestore.BatchGetDocumentsRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_begin_transaction_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = firestore.BeginTransactionResponse.to_json(firestore.BeginTransactionResponse())
...
def test_begin_transaction_rest_bad_request(transport: str = 'rest', request_type=firestore.BeginTransactionRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_commit_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = firestore.CommitResponse.to_json(firestore.CommitResponse())
...
def test_commit_rest_bad_request(transport: str = 'rest', request_type=firestore.CommitRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_rollback_rest_bad_request(transport: str = 'rest', request_type=firestore.RollbackRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_run_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = firestore.RunQueryResponse.to_json(firestore.RunQueryResponse())
        req.return_value._content = "[{}]".format(req.return_value._content)
...
def test_run_query_rest_bad_request(transport: str = 'rest', request_type=firestore.RunQueryRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_run_aggregation_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = firestore.RunAggregationQueryResponse.to_json(firestore.RunAggregationQueryResponse())
        req.return_value._content = "[{}]".format(req.return_value._content)
...
def test_run_aggregation_query_rest_bad_request(transport: str = 'rest', request_type=firestore.RunAggregationQueryRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_partition_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = firestore.PartitionQueryResponse.to_json(firestore.PartitionQueryResponse())
...
def test_partition_query_rest_bad_request(transport: str = 'rest', request_type=firestore.PartitionQueryRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_collection_ids_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = firestore.ListCollectionIdsResponse.to_json(firestore.ListCollectionIdsResponse())
...
def test_list_collection_ids_rest_bad_request(transport: str = 'rest', request_type=firestore.ListCollectionIdsRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_write_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = firestore.BatchWriteResponse.to_json(firestore.BatchWriteResponse())
...
def test_batch_write_rest_bad_request(transport: str = 'rest', request_type=firestore.BatchWriteRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_document_rest_bad_request(transport: str = 'rest', request_type=firestore.CreateDocumentRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
