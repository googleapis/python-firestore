...
def test_get_document_rest_unset_required_fields():
    transport = transports.FirestoreRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_batch_get_documents_rest_required_fields(request_type=firestore.BatchGetDocumentsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_get_documents._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_partition_query_rest_required_fields(request_type=firestore.PartitionQueryRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).partition_query._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_collection_ids_rest_required_fields(request_type=firestore.ListCollectionIdsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_collection_ids._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_write_rest_required_fields(request_type=firestore.BatchWriteRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).batch_write._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
