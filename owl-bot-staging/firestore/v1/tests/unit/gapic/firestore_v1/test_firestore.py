...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert FirestoreClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert FirestoreClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert FirestoreClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert FirestoreClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert FirestoreClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(FirestoreClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(FirestoreClient))
@mock.patch.object(FirestoreAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(FirestoreAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = FirestoreClient._DEFAULT_UNIVERSE
    default_endpoint = FirestoreClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = FirestoreClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert FirestoreClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert FirestoreClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == FirestoreClient.DEFAULT_MTLS_ENDPOINT
    assert FirestoreClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert FirestoreClient._get_api_endpoint(None, None, default_universe, "always") == FirestoreClient.DEFAULT_MTLS_ENDPOINT
    assert FirestoreClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == FirestoreClient.DEFAULT_MTLS_ENDPOINT
    assert FirestoreClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert FirestoreClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        FirestoreClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert FirestoreClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert FirestoreClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert FirestoreClient._get_universe_domain(None, None) == FirestoreClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class", [
    FirestoreClient, FirestoreAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (FirestoreAsyncClient, transports.FirestoreGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (FirestoreClient, transports.FirestoreRestTransport, "rest", None),
])
def test_firestore_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_firestore_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_batch_get_documents_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.batch_get_documents in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.batch_get_documents] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_batch_get_documents_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FirestoreAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.batch_get_documents in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.batch_get_documents] = mock_rpc
...
@pytest.mark.asyncio
async def test_run_aggregation_query_async(transport: str = 'grpc_asyncio', request_type=firestore.RunAggregationQueryRequest):
    client = FirestoreAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = mock.Mock(aio.UnaryStreamCall, autospec=True)
        call.return_value.read = mock.AsyncMock(side_effect=[firestore.RunAggregationQueryResponse()])
...
async def test_write_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.write in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.write] = mock_rpc
...
async def test_listen_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.listen in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.listen] = mock_rpc
...
def test_list_collection_ids_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_collection_ids in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_collection_ids] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_collection_ids_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FirestoreAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_collection_ids in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_collection_ids] = mock_rpc
...
def test_get_document_rest_required_fields(request_type=firestore.GetDocumentRequest):
    ...
    assert not set(unset_fields) - set(("mask", "read_time", "transaction", ))
    jsonified_request.update(unset_fields)
...
def test_get_document_rest_unset_required_fields():
    transport = transports.FirestoreRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.get_document._get_unset_required_fields({})
    assert set(unset_fields) == (set(("mask", "readTime", "transaction", )) & set(("name", )))
...
def test_list_documents_rest_required_fields(request_type=firestore.ListDocumentsRequest):
    transport_class = transports.FirestoreRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_documents._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("mask", "order_by", "page_size", "page_token", "read_time", "show_missing", "transaction", ))
    jsonified_request.update(unset_fields)
...
def test_list_documents_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("mask", "orderBy", "pageSize", "pageToken", "readTime", "showMissing", "transaction", )) & set(("parent", )))
...
def test_list_documents_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        sample_request = {'parent': 'projects/sample1/databases/sample2/documents/sample3/sample4', 'collection_id': 'sample5'}
...
def test_update_document_rest_required_fields(request_type=firestore.UpdateDocumentRequest):
    transport_class = transports.FirestoreRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_document._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("current_document", "mask", "update_mask", ))
    jsonified_request.update(unset_fields)
...
def test_update_document_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("currentDocument", "mask", "updateMask", )) & set(("document", )))
...
def test_update_document_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        sample_request = {'document': {'name': 'projects/sample1/databases/sample2/documents/sample3/sample4'}}
        ...
        assert path_template.validate("%s/v1/{document.name=projects/*/databases/*/documents/*/**}" % client.transport._host, args[1])
...
def test_delete_document_rest_required_fields(request_type=firestore.DeleteDocumentRequest):
    transport_class = transports.FirestoreRestTransport
...
def test_delete_document_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/databases/sample2/documents/sample3/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/databases/*/documents/*/**}" % client.transport._host, args[1])
...
def test_batch_get_documents_rest_required_fields(request_type=firestore.BatchGetDocumentsRequest):
    transport_class = transports.FirestoreRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_get_documents._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_begin_transaction_rest_required_fields(request_type=firestore.BeginTransactionRequest):
    transport_class = transports.FirestoreRestTransport
...
def test_begin_transaction_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{database=projects/*/databases/*}/documents:beginTransaction" % client.transport._host, args[1])
...
def test_commit_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{database=projects/*/databases/*}/documents:commit" % client.transport._host, args[1])
...
def test_rollback_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("database", "transaction", )))
...
def test_rollback_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{database=projects/*/databases/*}/documents:rollback" % client.transport._host, args[1])
...
def test_run_aggregation_query_rest_required_fields(request_type=firestore.RunAggregationQueryRequest):
    transport_class = transports.FirestoreRestTransport
...
def test_partition_query_rest_required_fields(request_type=firestore.PartitionQueryRequest):
    transport_class = transports.FirestoreRestTransport
...
def test_list_collection_ids_rest_required_fields(request_type=firestore.ListCollectionIdsRequest):
    transport_class = transports.FirestoreRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_collection_ids._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_collection_ids_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/databases/*/documents}:listCollectionIds" % client.transport._host, args[1])
...
def test_list_collection_ids_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(firestore.ListCollectionIdsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_create_document_rest_required_fields(request_type=firestore.CreateDocumentRequest):
    transport_class = transports.FirestoreRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_document._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("document_id", "mask", ))
    jsonified_request.update(unset_fields)
...
def test_create_document_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("documentId", "mask", )) & set(("parent", "collectionId", "document", )))
...
def test_get_document_rest_bad_request(request_type=firestore.GetDocumentRequest):
    ...
    request_init = {'name': 'projects/sample1/databases/sample2/documents/sample3/sample4'}
    request = request_type(**request_init)
...
def test_get_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.FirestoreRestInterceptor, "post_get_document") as post, \
        mock.patch.object(transports.FirestoreRestInterceptor, "post_get_document_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreRestInterceptor, "pre_get_document") as pre:
...
def test_list_documents_rest_bad_request(request_type=firestore.ListDocumentsRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/databases/sample2/documents/sample3/sample4', 'collection_id': 'sample5'}
    request = request_type(**request_init)
...
def test_list_documents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreRestInterceptor, "post_list_documents") as post, \
        mock.patch.object(transports.FirestoreRestInterceptor, "post_list_documents_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreRestInterceptor, "pre_list_documents") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = firestore.ListDocumentsResponse.to_json(firestore.ListDocumentsResponse())
        req.return_value.content = return_value
...
def test_update_document_rest_bad_request(request_type=firestore.UpdateDocumentRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'document': {'name': 'projects/sample1/databases/sample2/documents/sample3/sample4'}}
    request = request_type(**request_init)
...
def test_update_document_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'document': {'name': 'projects/sample1/databases/sample2/documents/sample3/sample4'}}
    request_init["document"] = {'name': 'projects/sample1/databases/sample2/documents/sample3/sample4', 'fields': {}, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}}
...
def test_update_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreRestInterceptor, "post_update_document") as post, \
        mock.patch.object(transports.FirestoreRestInterceptor, "post_update_document_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreRestInterceptor, "pre_update_document") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore.UpdateDocumentRequest.pb(firestore.UpdateDocumentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreRestInterceptor, "pre_delete_document") as pre:
        pre.assert_not_called()
        pb_message = firestore.DeleteDocumentRequest.pb(firestore.DeleteDocumentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_batch_get_documents_rest_bad_request(request_type=firestore.BatchGetDocumentsRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_batch_get_documents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreRestInterceptor, "post_batch_get_documents") as post, \
        mock.patch.object(transports.FirestoreRestInterceptor, "post_batch_get_documents_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreRestInterceptor, "pre_batch_get_documents") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore.BatchGetDocumentsRequest.pb(firestore.BatchGetDocumentsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = firestore.BatchGetDocumentsResponse.to_json(firestore.BatchGetDocumentsResponse())
        ...
        post_with_metadata.return_value = firestore.BatchGetDocumentsResponse(), metadata

        client.batch_get_documents(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_begin_transaction_rest_bad_request(request_type=firestore.BeginTransactionRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_begin_transaction_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreRestInterceptor, "post_begin_transaction") as post, \
        mock.patch.object(transports.FirestoreRestInterceptor, "post_begin_transaction_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreRestInterceptor, "pre_begin_transaction") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore.BeginTransactionRequest.pb(firestore.BeginTransactionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = firestore.BeginTransactionResponse.to_json(firestore.BeginTransactionResponse())
        req.return_value.content = return_value
...
def test_commit_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.FirestoreRestInterceptor, "post_commit_with_metadata") as post_with_metadata, \
...
def test_run_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreRestInterceptor, "post_run_query") as post, \
        mock.patch.object(transports.FirestoreRestInterceptor, "post_run_query_with_metadata") as post_with_metadata, \
...
def test_run_aggregation_query_rest_bad_request(request_type=firestore.RunAggregationQueryRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_run_aggregation_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreRestInterceptor, "post_run_aggregation_query") as post, \
        mock.patch.object(transports.FirestoreRestInterceptor, "post_run_aggregation_query_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreRestInterceptor, "pre_run_aggregation_query") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore.RunAggregationQueryRequest.pb(firestore.RunAggregationQueryRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = firestore.RunAggregationQueryResponse.to_json(firestore.RunAggregationQueryResponse())
        req.return_value.iter_content = mock.Mock(return_value=iter(return_value))
        ...
        post_with_metadata.return_value = firestore.RunAggregationQueryResponse(), metadata
...
def test_partition_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreRestInterceptor, "post_partition_query") as post, \
        mock.patch.object(transports.FirestoreRestInterceptor, "post_partition_query_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreRestInterceptor, "pre_partition_query") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore.PartitionQueryRequest.pb(firestore.PartitionQueryRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = firestore.PartitionQueryResponse.to_json(firestore.PartitionQueryResponse())
        req.return_value.content = return_value
...
def test_list_collection_ids_rest_bad_request(request_type=firestore.ListCollectionIdsRequest):
    client = FirestoreClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_collection_ids_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreRestInterceptor, "post_list_collection_ids") as post, \
        mock.patch.object(transports.FirestoreRestInterceptor, "post_list_collection_ids_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreRestInterceptor, "pre_list_collection_ids") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore.ListCollectionIdsRequest.pb(firestore.ListCollectionIdsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = firestore.ListCollectionIdsResponse.to_json(firestore.ListCollectionIdsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = firestore.ListCollectionIdsResponse(), metadata

        client.list_collection_ids(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_batch_write_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreRestInterceptor, "post_batch_write") as post, \
        mock.patch.object(transports.FirestoreRestInterceptor, "post_batch_write_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreRestInterceptor, "pre_batch_write") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = firestore.BatchWriteResponse.to_json(firestore.BatchWriteResponse())
        req.return_value.content = return_value
...
def test_create_document_rest_bad_request(request_type=firestore.CreateDocumentRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/databases/sample2/documents/sample3', 'collection_id': 'sample4'}
    request = request_type(**request_init)
...
def test_create_document_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/databases/sample2/documents/sample3', 'collection_id': 'sample4'}
    request_init["document"] = {'name': 'name_value', 'fields': {}, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_document_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreRestInterceptor, "post_create_document") as post, \
        mock.patch.object(transports.FirestoreRestInterceptor, "post_create_document_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreRestInterceptor, "pre_create_document") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore.CreateDocumentRequest.pb(firestore.CreateDocumentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_firestore_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.firestore_v1.services.firestore.transports.FirestoreTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_firestore_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.firestore_v1.services.firestore.transports.FirestoreTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.FirestoreTransport()
        adc.assert_called_once()
