...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert FirestoreAdminClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert FirestoreAdminClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert FirestoreAdminClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert FirestoreAdminClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert FirestoreAdminClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert FirestoreAdminClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert FirestoreAdminClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert FirestoreAdminClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(FirestoreAdminClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(FirestoreAdminClient))
@mock.patch.object(FirestoreAdminAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(FirestoreAdminAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = FirestoreAdminClient._DEFAULT_UNIVERSE
    default_endpoint = FirestoreAdminClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = FirestoreAdminClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert FirestoreAdminClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert FirestoreAdminClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == FirestoreAdminClient.DEFAULT_MTLS_ENDPOINT
    assert FirestoreAdminClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert FirestoreAdminClient._get_api_endpoint(None, None, default_universe, "always") == FirestoreAdminClient.DEFAULT_MTLS_ENDPOINT
    assert FirestoreAdminClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == FirestoreAdminClient.DEFAULT_MTLS_ENDPOINT
    assert FirestoreAdminClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert FirestoreAdminClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        FirestoreAdminClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert FirestoreAdminClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert FirestoreAdminClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert FirestoreAdminClient._get_universe_domain(None, None) == FirestoreAdminClient._DEFAULT_UNIVERSE
...
def test_firestore_admin_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize("client_class", [
    FirestoreAdminClient, FirestoreAdminAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (FirestoreAdminClient, transports.FirestoreAdminGrpcTransport, "grpc", grpc_helpers),
    (FirestoreAdminAsyncClient, transports.FirestoreAdminGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (FirestoreAdminClient, transports.FirestoreAdminRestTransport, "rest", None),
])
def test_firestore_admin_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_firestore_admin_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
async def test_get_field_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_field in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_field] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_field_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FirestoreAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_field in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_field] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_fields_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FirestoreAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_fields in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_fields] = mock_rpc
...
def test_export_documents_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.export_documents] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_export_documents_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FirestoreAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.export_documents in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.export_documents] = mock_rpc
...
def test_bulk_delete_documents(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.bulk_delete_documents),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_bulk_delete_documents_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.bulk_delete_documents in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.bulk_delete_documents] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_bulk_delete_documents_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FirestoreAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.bulk_delete_documents in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.bulk_delete_documents] = mock_rpc
...
@pytest.mark.asyncio
async def test_bulk_delete_documents_async(transport: str = 'grpc_asyncio', request_type=firestore_admin.BulkDeleteDocumentsRequest):
    client = FirestoreAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_create_database_async(transport: str = 'grpc_asyncio', request_type=firestore_admin.CreateDatabaseRequest):
    client = FirestoreAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_database(request_type, transport: str = 'grpc'):
    ...
    assert response.point_in_time_recovery_enablement == database.Database.PointInTimeRecoveryEnablement.POINT_IN_TIME_RECOVERY_ENABLED
    assert response.app_engine_integration_mode == database.Database.AppEngineIntegrationMode.ENABLED
    assert response.key_prefix == 'key_prefix_value'
    assert response.delete_protection_state == database.Database.DeleteProtectionState.DELETE_PROTECTION_DISABLED
...
@pytest.mark.asyncio
async def test_get_database_async(transport: str = 'grpc_asyncio', request_type=firestore_admin.GetDatabaseRequest):
    client = FirestoreAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_databases_async(transport: str = 'grpc_asyncio', request_type=firestore_admin.ListDatabasesRequest):
    client = FirestoreAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(firestore_admin.ListDatabasesResponse(
            unreachable=['unreachable_value'],
        ))
...
@pytest.mark.asyncio
async def test_update_database_async(transport: str = 'grpc_asyncio', request_type=firestore_admin.UpdateDatabaseRequest):
    client = FirestoreAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_database_async(transport: str = 'grpc_asyncio', request_type=firestore_admin.DeleteDatabaseRequest):
    client = FirestoreAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_user_creds(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_user_creds),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_user_creds_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_user_creds] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_user_creds_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FirestoreAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_user_creds in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_user_creds] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_user_creds_async(transport: str = 'grpc_asyncio', request_type=firestore_admin.CreateUserCredsRequest):
    client = FirestoreAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_user_creds(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_user_creds),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_user_creds_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FirestoreAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_user_creds in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_user_creds] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_user_creds_async(transport: str = 'grpc_asyncio', request_type=firestore_admin.GetUserCredsRequest):
    client = FirestoreAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(user_creds.UserCreds(
            name='name_value',
            state=user_creds.UserCreds.State.ENABLED,
            secure_password='secure_password_value',
        ))
...
def test_list_user_creds(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_user_creds),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_user_creds_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FirestoreAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_user_creds in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_user_creds] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_user_creds_async(transport: str = 'grpc_asyncio', request_type=firestore_admin.ListUserCredsRequest):
    client = FirestoreAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_enable_user_creds(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.enable_user_creds),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = user_creds.UserCreds(
            name='name_value',
...
def test_enable_user_creds_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.enable_user_creds] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_enable_user_creds_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FirestoreAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.enable_user_creds in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.enable_user_creds] = mock_rpc
...
@pytest.mark.asyncio
async def test_enable_user_creds_async(transport: str = 'grpc_asyncio', request_type=firestore_admin.EnableUserCredsRequest):
    client = FirestoreAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_disable_user_creds(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.disable_user_creds),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = user_creds.UserCreds(
            name='name_value',
...
def test_disable_user_creds_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.disable_user_creds in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.disable_user_creds] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_disable_user_creds_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FirestoreAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.disable_user_creds in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.disable_user_creds] = mock_rpc
...
@pytest.mark.asyncio
async def test_disable_user_creds_async(transport: str = 'grpc_asyncio', request_type=firestore_admin.DisableUserCredsRequest):
    client = FirestoreAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_reset_user_password(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.reset_user_password),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = user_creds.UserCreds(
            name='name_value',
...
def test_reset_user_password_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.reset_user_password in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.reset_user_password] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_reset_user_password_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FirestoreAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.reset_user_password in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.reset_user_password] = mock_rpc
...
@pytest.mark.asyncio
async def test_reset_user_password_async(transport: str = 'grpc_asyncio', request_type=firestore_admin.ResetUserPasswordRequest):
    client = FirestoreAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_user_creds(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_user_creds),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_delete_user_creds_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_user_creds] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_user_creds_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FirestoreAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_user_creds in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_user_creds] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_user_creds_async(transport: str = 'grpc_asyncio', request_type=firestore_admin.DeleteUserCredsRequest):
    client = FirestoreAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_get_backup_async(transport: str = 'grpc_asyncio', request_type=firestore_admin.GetBackupRequest):
    client = FirestoreAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_backups_async(transport: str = 'grpc_asyncio', request_type=firestore_admin.ListBackupsRequest):
    client = FirestoreAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(firestore_admin.ListBackupsResponse(
            unreachable=['unreachable_value'],
        ))
...
@pytest.mark.asyncio
async def test_delete_backup_async(transport: str = 'grpc_asyncio', request_type=firestore_admin.DeleteBackupRequest):
    client = FirestoreAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_restore_database_async(transport: str = 'grpc_asyncio', request_type=firestore_admin.RestoreDatabaseRequest):
    client = FirestoreAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_create_backup_schedule_async(transport: str = 'grpc_asyncio', request_type=firestore_admin.CreateBackupScheduleRequest):
    client = FirestoreAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(schedule.BackupSchedule(
            name='name_value',
        ))
...
@pytest.mark.asyncio
async def test_get_backup_schedule_async(transport: str = 'grpc_asyncio', request_type=firestore_admin.GetBackupScheduleRequest):
    client = FirestoreAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_backup_schedules_async(transport: str = 'grpc_asyncio', request_type=firestore_admin.ListBackupSchedulesRequest):
    client = FirestoreAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(firestore_admin.ListBackupSchedulesResponse(
        ))
...
@pytest.mark.asyncio
async def test_update_backup_schedule_async(transport: str = 'grpc_asyncio', request_type=firestore_admin.UpdateBackupScheduleRequest):
    client = FirestoreAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_backup_schedule_async(transport: str = 'grpc_asyncio', request_type=firestore_admin.DeleteBackupScheduleRequest):
    client = FirestoreAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_clone_database(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.clone_database),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_clone_database_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FirestoreAdminAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.clone_database in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.clone_database] = mock_rpc
...
@pytest.mark.asyncio
async def test_clone_database_async(transport: str = 'grpc_asyncio', request_type=firestore_admin.CloneDatabaseRequest):
    client = FirestoreAdminAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_index_rest_required_fields(request_type=firestore_admin.CreateIndexRequest):
...
def test_create_index_rest_unset_required_fields():
    transport = transports.FirestoreAdminRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_create_index_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        sample_request = {'parent': 'projects/sample1/databases/sample2/collectionGroups/sample3'}
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/databases/*/collectionGroups/*}/indexes" % client.transport._host, args[1])
...
def test_list_indexes_rest_required_fields(request_type=firestore_admin.ListIndexesRequest):
    transport_class = transports.FirestoreAdminRestTransport
...
def test_list_indexes_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(firestore_admin.ListIndexesResponse.to_json(x) for x in response)
...
def test_get_index_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/databases/sample2/collectionGroups/sample3/indexes/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/databases/*/collectionGroups/*/indexes/*}" % client.transport._host, args[1])
...
def test_delete_index_rest_required_fields(request_type=firestore_admin.DeleteIndexRequest):
    transport_class = transports.FirestoreAdminRestTransport
...
def test_get_field_rest_required_fields(request_type=firestore_admin.GetFieldRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_field._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_field_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/databases/sample2/collectionGroups/sample3/fields/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/databases/*/collectionGroups/*/fields/*}" % client.transport._host, args[1])
...
def test_update_field_rest_required_fields(request_type=firestore_admin.UpdateFieldRequest):
    transport_class = transports.FirestoreAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_field._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_field_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'field': {'name': 'projects/sample1/databases/sample2/collectionGroups/sample3/fields/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{field.name=projects/*/databases/*/collectionGroups/*/fields/*}" % client.transport._host, args[1])
...
def test_list_fields_rest_required_fields(request_type=firestore_admin.ListFieldsRequest):
    transport_class = transports.FirestoreAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_fields._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_fields_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/databases/*/collectionGroups/*}/fields" % client.transport._host, args[1])
...
def test_list_fields_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(firestore_admin.ListFieldsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_export_documents_rest_required_fields(request_type=firestore_admin.ExportDocumentsRequest):
    transport_class = transports.FirestoreAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).export_documents._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_export_documents_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/databases/*}:exportDocuments" % client.transport._host, args[1])
...
def test_import_documents_rest_required_fields(request_type=firestore_admin.ImportDocumentsRequest):
    transport_class = transports.FirestoreAdminRestTransport
...
def test_import_documents_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/databases/*}:importDocuments" % client.transport._host, args[1])
...
def test_bulk_delete_documents_rest_required_fields(request_type=firestore_admin.BulkDeleteDocumentsRequest):
    transport_class = transports.FirestoreAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).bulk_delete_documents._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_bulk_delete_documents_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/databases/*}:bulkDeleteDocuments" % client.transport._host, args[1])
...
def test_create_database_rest_required_fields(request_type=firestore_admin.CreateDatabaseRequest):
    transport_class = transports.FirestoreAdminRestTransport
...
def test_create_database_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*}/databases" % client.transport._host, args[1])
...
def test_get_database_rest_required_fields(request_type=firestore_admin.GetDatabaseRequest):
    transport_class = transports.FirestoreAdminRestTransport
...
def test_get_database_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/databases/*}" % client.transport._host, args[1])
...
def test_update_database_rest_required_fields(request_type=firestore_admin.UpdateDatabaseRequest):
    transport_class = transports.FirestoreAdminRestTransport
...
def test_update_database_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{database.name=projects/*/databases/*}" % client.transport._host, args[1])
...
def test_delete_database_rest_required_fields(request_type=firestore_admin.DeleteDatabaseRequest):
    transport_class = transports.FirestoreAdminRestTransport
...
def test_create_user_creds_rest_required_fields(request_type=firestore_admin.CreateUserCredsRequest):
    transport_class = transports.FirestoreAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_user_creds._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_user_creds_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("userCredsId", )) & set(("parent", "userCreds", "userCredsId", )))
...
def test_create_user_creds_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/databases/*}/userCreds" % client.transport._host, args[1])
...
def test_get_user_creds_rest_required_fields(request_type=firestore_admin.GetUserCredsRequest):
    transport_class = transports.FirestoreAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_user_creds._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_user_creds_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/databases/sample2/userCreds/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/databases/*/userCreds/*}" % client.transport._host, args[1])
...
def test_list_user_creds_rest_required_fields(request_type=firestore_admin.ListUserCredsRequest):
    transport_class = transports.FirestoreAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_user_creds._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_enable_user_creds_rest_required_fields(request_type=firestore_admin.EnableUserCredsRequest):
    transport_class = transports.FirestoreAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).enable_user_creds._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_enable_user_creds_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/databases/*/userCreds/*}:enable" % client.transport._host, args[1])
...
def test_disable_user_creds_rest_required_fields(request_type=firestore_admin.DisableUserCredsRequest):
    transport_class = transports.FirestoreAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).disable_user_creds._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_disable_user_creds_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/databases/*/userCreds/*}:disable" % client.transport._host, args[1])
...
def test_reset_user_password_rest_required_fields(request_type=firestore_admin.ResetUserPasswordRequest):
    transport_class = transports.FirestoreAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).reset_user_password._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_reset_user_password_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/databases/*/userCreds/*}:resetPassword" % client.transport._host, args[1])
...
def test_delete_user_creds_rest_required_fields(request_type=firestore_admin.DeleteUserCredsRequest):
    transport_class = transports.FirestoreAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_user_creds._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_backups_rest_required_fields(request_type=firestore_admin.ListBackupsRequest):
    transport_class = transports.FirestoreAdminRestTransport
...
def test_delete_backup_rest_required_fields(request_type=firestore_admin.DeleteBackupRequest):
    transport_class = transports.FirestoreAdminRestTransport
...
def test_restore_database_rest_required_fields(request_type=firestore_admin.RestoreDatabaseRequest):
    transport_class = transports.FirestoreAdminRestTransport
...
def test_restore_database_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "databaseId", "backup", )))
...
def test_create_backup_schedule_rest_required_fields(request_type=firestore_admin.CreateBackupScheduleRequest):
    transport_class = transports.FirestoreAdminRestTransport
...
def test_create_backup_schedule_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "backupSchedule", )))
...
def test_create_backup_schedule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/databases/*}/backupSchedules" % client.transport._host, args[1])
...
def test_get_backup_schedule_rest_required_fields(request_type=firestore_admin.GetBackupScheduleRequest):
    transport_class = transports.FirestoreAdminRestTransport
...
def test_get_backup_schedule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/databases/sample2/backupSchedules/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/databases/*/backupSchedules/*}" % client.transport._host, args[1])
...
def test_list_backup_schedules_rest_required_fields(request_type=firestore_admin.ListBackupSchedulesRequest):
    transport_class = transports.FirestoreAdminRestTransport
...
def test_update_backup_schedule_rest_required_fields(request_type=firestore_admin.UpdateBackupScheduleRequest):
    transport_class = transports.FirestoreAdminRestTransport
...
def test_update_backup_schedule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'backup_schedule': {'name': 'projects/sample1/databases/sample2/backupSchedules/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{backup_schedule.name=projects/*/databases/*/backupSchedules/*}" % client.transport._host, args[1])
...
def test_delete_backup_schedule_rest_required_fields(request_type=firestore_admin.DeleteBackupScheduleRequest):
    transport_class = transports.FirestoreAdminRestTransport
...
def test_clone_database_rest_required_fields(request_type=firestore_admin.CloneDatabaseRequest):
    transport_class = transports.FirestoreAdminRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).clone_database._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_clone_database_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "databaseId", "pitrSnapshot", )))
...
def test_clone_database_routing_parameters_request_1_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.clone_database(request={"pitr_snapshot": {"database": "projects/sample1/sample2"}})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = firestore_admin.CloneDatabaseRequest(**{"pitr_snapshot": {"database": "projects/sample1/sample2"}})
...
def test_clone_database_routing_parameters_request_2_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.clone_database(request={"pitr_snapshot": {"database": "projects/sample1/databases/sample2/sample3"}})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = firestore_admin.CloneDatabaseRequest(**{"pitr_snapshot": {"database": "projects/sample1/databases/sample2/sample3"}})
...
async def test_clone_database_routing_parameters_request_1_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        await client.clone_database(request={"pitr_snapshot": {"database": "projects/sample1/sample2"}})
...
async def test_clone_database_routing_parameters_request_2_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        await client.clone_database(request={"pitr_snapshot": {"database": "projects/sample1/databases/sample2/sample3"}})
...
def test_create_index_rest_bad_request(request_type=firestore_admin.CreateIndexRequest):
    ...
    request_init = {'parent': 'projects/sample1/databases/sample2/collectionGroups/sample3'}
    request = request_type(**request_init)
...
def test_create_index_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/databases/sample2/collectionGroups/sample3'}
    request_init["index"] = {'name': 'name_value', 'query_scope': 1, 'api_scope': 1, 'fields': [{'field_path': 'field_path_value', 'order': 1, 'array_config': 1, 'vector_config': {'dimension': 966, 'flat': {}}}], 'state': 1, 'density': 1, 'multikey': True, 'shard_count': 1178}
...
def test_create_index_rest_interceptors(null_interceptor):
    transport = transports.FirestoreAdminRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.FirestoreAdminRestInterceptor(),
        )
    client = FirestoreAdminClient(transport=transport)
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_create_index") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_create_index_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_create_index") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.CreateIndexRequest.pb(firestore_admin.CreateIndexRequest())
...
def test_list_indexes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_list_indexes") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_list_indexes_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_list_indexes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.ListIndexesRequest.pb(firestore_admin.ListIndexesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = firestore_admin.ListIndexesResponse.to_json(firestore_admin.ListIndexesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = firestore_admin.ListIndexesResponse(), metadata
...
def test_get_index_rest_bad_request(request_type=firestore_admin.GetIndexRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/databases/sample2/collectionGroups/sample3/indexes/sample4'}
    request = request_type(**request_init)
...
def test_get_index_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_get_index") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_get_index_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_get_index") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.GetIndexRequest.pb(firestore_admin.GetIndexRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_index_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_delete_index") as pre:
        pre.assert_not_called()
        pb_message = firestore_admin.DeleteIndexRequest.pb(firestore_admin.DeleteIndexRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_field_rest_bad_request(request_type=firestore_admin.GetFieldRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/databases/sample2/collectionGroups/sample3/fields/sample4'}
    request = request_type(**request_init)
...
def test_get_field_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_get_field") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_get_field_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_get_field") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.GetFieldRequest.pb(firestore_admin.GetFieldRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_field(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_field_rest_bad_request(request_type=firestore_admin.UpdateFieldRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'field': {'name': 'projects/sample1/databases/sample2/collectionGroups/sample3/fields/sample4'}}
    request = request_type(**request_init)
...
def test_update_field_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'field': {'name': 'projects/sample1/databases/sample2/collectionGroups/sample3/fields/sample4'}}
    request_init["field"] = {'name': 'projects/sample1/databases/sample2/collectionGroups/sample3/fields/sample4', 'index_config': {'indexes': [{'name': 'name_value', 'query_scope': 1, 'api_scope': 1, 'fields': [{'field_path': 'field_path_value', 'order': 1, 'array_config': 1, 'vector_config': {'dimension': 966, 'flat': {}}}], 'state': 1, 'density': 1, 'multikey': True, 'shard_count': 1178}], 'uses_ancestor_config': True, 'ancestor_field': 'ancestor_field_value', 'reverting': True}, 'ttl_config': {'state': 1}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_field_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_update_field") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_update_field_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_update_field") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.UpdateFieldRequest.pb(firestore_admin.UpdateFieldRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_field(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_fields_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_list_fields") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_list_fields_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_list_fields") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.ListFieldsRequest.pb(firestore_admin.ListFieldsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = firestore_admin.ListFieldsResponse.to_json(firestore_admin.ListFieldsResponse())
        req.return_value.content = return_value
        ...
        client.list_fields(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_export_documents_rest_bad_request(request_type=firestore_admin.ExportDocumentsRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_export_documents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_export_documents") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_export_documents_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_export_documents") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.ExportDocumentsRequest.pb(firestore_admin.ExportDocumentsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.export_documents(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_import_documents_rest_bad_request(request_type=firestore_admin.ImportDocumentsRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_import_documents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_import_documents") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_import_documents_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_import_documents") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.ImportDocumentsRequest.pb(firestore_admin.ImportDocumentsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_bulk_delete_documents_rest_bad_request(request_type=firestore_admin.BulkDeleteDocumentsRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_bulk_delete_documents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_bulk_delete_documents") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_bulk_delete_documents_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_bulk_delete_documents") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.BulkDeleteDocumentsRequest.pb(firestore_admin.BulkDeleteDocumentsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.bulk_delete_documents(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_database_rest_bad_request(request_type=firestore_admin.CreateDatabaseRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_database_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_create_database") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_create_database_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_create_database") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.CreateDatabaseRequest.pb(firestore_admin.CreateDatabaseRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_database_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_get_database") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_get_database_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_get_database") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.GetDatabaseRequest.pb(firestore_admin.GetDatabaseRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_databases_rest_bad_request(request_type=firestore_admin.ListDatabasesRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_databases_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_list_databases") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_list_databases_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_list_databases") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.ListDatabasesRequest.pb(firestore_admin.ListDatabasesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = firestore_admin.ListDatabasesResponse.to_json(firestore_admin.ListDatabasesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = firestore_admin.ListDatabasesResponse(), metadata
...
def test_update_database_rest_bad_request(request_type=firestore_admin.UpdateDatabaseRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_database_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_update_database") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_update_database_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_update_database") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.UpdateDatabaseRequest.pb(firestore_admin.UpdateDatabaseRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_database_rest_bad_request(request_type=firestore_admin.DeleteDatabaseRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_database_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_delete_database") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_delete_database_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_delete_database") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.DeleteDatabaseRequest.pb(firestore_admin.DeleteDatabaseRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_create_user_creds_rest_bad_request(request_type=firestore_admin.CreateUserCredsRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_user_creds_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/databases/sample2'}
    request_init["user_creds"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'state': 1, 'secure_password': 'secure_password_value', 'resource_identity': {'principal': 'principal_value'}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_user_creds_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_create_user_creds") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_create_user_creds_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_create_user_creds") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.CreateUserCredsRequest.pb(firestore_admin.CreateUserCredsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_user_creds(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_user_creds_rest_bad_request(request_type=firestore_admin.GetUserCredsRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_user_creds_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_get_user_creds") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_get_user_creds_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_get_user_creds") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.GetUserCredsRequest.pb(firestore_admin.GetUserCredsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_user_creds(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_user_creds_rest_bad_request(request_type=firestore_admin.ListUserCredsRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_user_creds_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_list_user_creds") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_list_user_creds_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_list_user_creds") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.ListUserCredsRequest.pb(firestore_admin.ListUserCredsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = firestore_admin.ListUserCredsResponse.to_json(firestore_admin.ListUserCredsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = firestore_admin.ListUserCredsResponse(), metadata

        client.list_user_creds(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_enable_user_creds_rest_bad_request(request_type=firestore_admin.EnableUserCredsRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_enable_user_creds_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_enable_user_creds") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_enable_user_creds_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_enable_user_creds") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.EnableUserCredsRequest.pb(firestore_admin.EnableUserCredsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.enable_user_creds(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_disable_user_creds_rest_bad_request(request_type=firestore_admin.DisableUserCredsRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_disable_user_creds_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_disable_user_creds") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_disable_user_creds_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_disable_user_creds") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.DisableUserCredsRequest.pb(firestore_admin.DisableUserCredsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.disable_user_creds(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_reset_user_password_rest_bad_request(request_type=firestore_admin.ResetUserPasswordRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_reset_user_password_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_reset_user_password") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_reset_user_password_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_reset_user_password") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.ResetUserPasswordRequest.pb(firestore_admin.ResetUserPasswordRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.reset_user_password(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_user_creds_rest_bad_request(request_type=firestore_admin.DeleteUserCredsRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_user_creds_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_delete_user_creds") as pre:
        pre.assert_not_called()
        pb_message = firestore_admin.DeleteUserCredsRequest.pb(firestore_admin.DeleteUserCredsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_user_creds(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_get_backup") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_get_backup_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_get_backup") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.GetBackupRequest.pb(firestore_admin.GetBackupRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_backups_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_list_backups") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_list_backups_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_list_backups") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.ListBackupsRequest.pb(firestore_admin.ListBackupsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = firestore_admin.ListBackupsResponse.to_json(firestore_admin.ListBackupsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = firestore_admin.ListBackupsResponse(), metadata
...
def test_delete_backup_rest_bad_request(request_type=firestore_admin.DeleteBackupRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_backup_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_delete_backup") as pre:
        pre.assert_not_called()
        pb_message = firestore_admin.DeleteBackupRequest.pb(firestore_admin.DeleteBackupRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_restore_database_rest_bad_request(request_type=firestore_admin.RestoreDatabaseRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_restore_database_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_restore_database") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_restore_database_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_restore_database") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.RestoreDatabaseRequest.pb(firestore_admin.RestoreDatabaseRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_create_backup_schedule_rest_bad_request(request_type=firestore_admin.CreateBackupScheduleRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_backup_schedule_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/databases/sample2'}
    request_init["backup_schedule"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'retention': {'seconds': 751, 'nanos': 543}, 'daily_recurrence': {}, 'weekly_recurrence': {'day': 1}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = firestore_admin.CreateBackupScheduleRequest.meta.fields["backup_schedule"]
...
def test_create_backup_schedule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_create_backup_schedule") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_create_backup_schedule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_create_backup_schedule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.CreateBackupScheduleRequest.pb(firestore_admin.CreateBackupScheduleRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_backup_schedule_rest_bad_request(request_type=firestore_admin.GetBackupScheduleRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/databases/sample2/backupSchedules/sample3'}
    request = request_type(**request_init)
...
def test_get_backup_schedule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_get_backup_schedule") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_get_backup_schedule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_get_backup_schedule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.GetBackupScheduleRequest.pb(firestore_admin.GetBackupScheduleRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_backup_schedules_rest_bad_request(request_type=firestore_admin.ListBackupSchedulesRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_backup_schedules_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_list_backup_schedules") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_list_backup_schedules_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_list_backup_schedules") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.ListBackupSchedulesRequest.pb(firestore_admin.ListBackupSchedulesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = firestore_admin.ListBackupSchedulesResponse.to_json(firestore_admin.ListBackupSchedulesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = firestore_admin.ListBackupSchedulesResponse(), metadata
...
def test_update_backup_schedule_rest_bad_request(request_type=firestore_admin.UpdateBackupScheduleRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'backup_schedule': {'name': 'projects/sample1/databases/sample2/backupSchedules/sample3'}}
    request = request_type(**request_init)
...
def test_update_backup_schedule_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'backup_schedule': {'name': 'projects/sample1/databases/sample2/backupSchedules/sample3'}}
    request_init["backup_schedule"] = {'name': 'projects/sample1/databases/sample2/backupSchedules/sample3', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'retention': {'seconds': 751, 'nanos': 543}, 'daily_recurrence': {}, 'weekly_recurrence': {'day': 1}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = firestore_admin.UpdateBackupScheduleRequest.meta.fields["backup_schedule"]
...
def test_update_backup_schedule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_update_backup_schedule") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_update_backup_schedule_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_update_backup_schedule") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.UpdateBackupScheduleRequest.pb(firestore_admin.UpdateBackupScheduleRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_backup_schedule_rest_bad_request(request_type=firestore_admin.DeleteBackupScheduleRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_backup_schedule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_delete_backup_schedule") as pre:
        pre.assert_not_called()
        pb_message = firestore_admin.DeleteBackupScheduleRequest.pb(firestore_admin.DeleteBackupScheduleRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_clone_database_rest_bad_request(request_type=firestore_admin.CloneDatabaseRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_clone_database_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_clone_database") as post, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "post_clone_database_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FirestoreAdminRestInterceptor, "pre_clone_database") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = firestore_admin.CloneDatabaseRequest.pb(firestore_admin.CloneDatabaseRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.clone_database(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_cancel_operation_rest_bad_request(request_type=operations_pb2.CancelOperationRequest):
    ...
    request = request_type()
    request = json_format.ParseDict({'name': 'projects/sample1/databases/sample2/operations/sample3'}, request)
...
def test_list_operations_rest_bad_request(request_type=operations_pb2.ListOperationsRequest):
    ...
    request = request_type()
    request = json_format.ParseDict({'name': 'projects/sample1/databases/sample2'}, request)
...
def test_firestore_admin_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.firestore_admin_v1.services.firestore_admin.transports.FirestoreAdminTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_firestore_admin_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.firestore_admin_v1.services.firestore_admin.transports.FirestoreAdminTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.FirestoreAdminTransport()
        adc.assert_called_once()
...
def test_backup_schedule_path():
    ...
    expected = "projects/{project}/databases/{database}/backupSchedules/{backup_schedule}".format(project=project, database=database, backup_schedule=backup_schedule, )
    actual = FirestoreAdminClient.backup_schedule_path(project, database, backup_schedule)
    assert expected == actual
...
def test_operation_path():
    ...
    database = "mussel"
    operation = "winkle"
    expected = "projects/{project}/databases/{database}/operations/{operation}".format(project=project, database=database, operation=operation, )
...
def test_user_creds_path():
    ...
    database = "clam"
    user_creds = "whelk"
    expected = "projects/{project}/databases/{database}/userCreds/{user_creds}".format(project=project, database=database, user_creds=user_creds, )
