...
async def test_list_fields_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_fields(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_create_database_rest(request_type):
    ...
    request_init["database"] = {'name': 'name_value', 'location_id': 'location_id_value', 'type_': 1, 'concurrency_mode': 1, 'app_engine_integration_mode': 1, 'key_prefix': 'key_prefix_value', 'etag': 'etag_value'}
    request = request_type(**request_init)
...
def test_update_database_rest(request_type):
    ...
    request_init["database"] = {'name': 'projects/sample1/databases/sample2', 'location_id': 'location_id_value', 'type_': 1, 'concurrency_mode': 1, 'app_engine_integration_mode': 1, 'key_prefix': 'key_prefix_value', 'etag': 'etag_value'}
    request = request_type(**request_init)
