...
def test_create_index_rest_bad_request(transport: str = 'rest', request_type=firestore_admin.CreateIndexRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_indexes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = firestore_admin.ListIndexesResponse.to_json(firestore_admin.ListIndexesResponse())
...
def test_list_indexes_rest_bad_request(transport: str = 'rest', request_type=firestore_admin.ListIndexesRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_index_rest_bad_request(transport: str = 'rest', request_type=firestore_admin.GetIndexRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_index_rest_bad_request(transport: str = 'rest', request_type=firestore_admin.DeleteIndexRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_field_rest_bad_request(transport: str = 'rest', request_type=firestore_admin.GetFieldRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_field_rest_bad_request(transport: str = 'rest', request_type=firestore_admin.UpdateFieldRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_fields_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = firestore_admin.ListFieldsResponse.to_json(firestore_admin.ListFieldsResponse())
...
def test_list_fields_rest_bad_request(transport: str = 'rest', request_type=firestore_admin.ListFieldsRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_export_documents_rest_bad_request(transport: str = 'rest', request_type=firestore_admin.ExportDocumentsRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_import_documents_rest_bad_request(transport: str = 'rest', request_type=firestore_admin.ImportDocumentsRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_bulk_delete_documents_rest_bad_request(transport: str = 'rest', request_type=firestore_admin.BulkDeleteDocumentsRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_database_rest_bad_request(transport: str = 'rest', request_type=firestore_admin.CreateDatabaseRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_database_rest_bad_request(transport: str = 'rest', request_type=firestore_admin.GetDatabaseRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_databases_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = firestore_admin.ListDatabasesResponse.to_json(firestore_admin.ListDatabasesResponse())
...
def test_update_database_rest_bad_request(transport: str = 'rest', request_type=firestore_admin.UpdateDatabaseRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_database_rest_bad_request(transport: str = 'rest', request_type=firestore_admin.DeleteDatabaseRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_backup_rest_bad_request(transport: str = 'rest', request_type=firestore_admin.GetBackupRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_backups_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = firestore_admin.ListBackupsResponse.to_json(firestore_admin.ListBackupsResponse())
...
def test_list_backups_rest_bad_request(transport: str = 'rest', request_type=firestore_admin.ListBackupsRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_backup_rest_bad_request(transport: str = 'rest', request_type=firestore_admin.DeleteBackupRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_restore_database_rest_bad_request(transport: str = 'rest', request_type=firestore_admin.RestoreDatabaseRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_backup_schedule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = schedule.BackupSchedule.to_json(schedule.BackupSchedule())
...
def test_create_backup_schedule_rest_bad_request(transport: str = 'rest', request_type=firestore_admin.CreateBackupScheduleRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_backup_schedule_rest_bad_request(transport: str = 'rest', request_type=firestore_admin.GetBackupScheduleRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_backup_schedules_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = firestore_admin.ListBackupSchedulesResponse.to_json(firestore_admin.ListBackupSchedulesResponse())
...
def test_update_backup_schedule_rest_bad_request(transport: str = 'rest', request_type=firestore_admin.UpdateBackupScheduleRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_backup_schedule_rest_bad_request(transport: str = 'rest', request_type=firestore_admin.DeleteBackupScheduleRequest):
    client = FirestoreAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
