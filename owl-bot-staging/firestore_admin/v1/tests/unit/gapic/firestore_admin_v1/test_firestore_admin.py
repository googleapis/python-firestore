...
def test_create_index_rest(request_type):
    ...
    request_init["index"] = {'name': 'name_value', 'query_scope': 1, 'api_scope': 1, 'fields': [{'field_path': 'field_path_value', 'order': 1, 'array_config': 1}], 'state': 1}
...
def test_update_field_rest(request_type):
    ...
    request_init["field"] = {'name': 'projects/sample1/databases/sample2/collectionGroups/sample3/fields/sample4', 'index_config': {'indexes': [{'name': 'name_value', 'query_scope': 1, 'api_scope': 1, 'fields': [{'field_path': 'field_path_value', 'order': 1, 'array_config': 1}], 'state': 1}], 'uses_ancestor_config': True, 'ancestor_field': 'ancestor_field_value', 'reverting': True}, 'ttl_config': {'state': 1}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
