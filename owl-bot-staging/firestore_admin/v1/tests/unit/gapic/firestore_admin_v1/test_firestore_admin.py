...
def test_create_index_rest_required_fields(request_type=firestore_admin.CreateIndexRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_index._get_unset_required_fields(jsonified_request)
...
def test_create_index_rest_unset_required_fields():
    transport = transports.FirestoreAdminRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_list_indexes_rest_required_fields(request_type=firestore_admin.ListIndexesRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_indexes._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_index_rest_required_fields(request_type=firestore_admin.GetIndexRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_index._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_index_rest_required_fields(request_type=firestore_admin.DeleteIndexRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_index._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_field_rest_required_fields(request_type=firestore_admin.GetFieldRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_field._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_field_rest_required_fields(request_type=firestore_admin.UpdateFieldRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_field._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_fields_rest_required_fields(request_type=firestore_admin.ListFieldsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_fields._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_export_documents_rest_required_fields(request_type=firestore_admin.ExportDocumentsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).export_documents._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
